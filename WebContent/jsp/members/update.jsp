...
<h2>[ 회원수정하기 ]</h2><br>
	<form method="post"	action="<%=request.getContextPath()%>/members.do?cmd=updateOk" onsubmit = "return insertCheck()">
	...
	<tr>
	<td>비밀번호 확인</td>
	<td><input type="password" name="memPwd2" id="pwd2" onkeyup="passwordCheck1()" placeholder="비밀번호 재확인" required>
		<span id="same2"></span> 
	</td>
	</tr>
