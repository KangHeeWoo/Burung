<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <!-- 아이디 <input type="text" name="memId" value="${requestScope.user.memId }"><br>  -->
		...
		비밀번호 <input type="password" name="memPwd" value="${pwd }"><br>

   		주소 <input type="text" name="memAddr" value="${Addr }"><br>
   		전화번호 <input type="text" name="memPhone" value="${Phone }"><br>
		이메일 <input type="text" name="memEmail" value="${Email }"><br>
		생년월일 <input type="text" name="memBirth" value="${Birth }"><br>
		이름 <input type="text" name="memName" value="${Name }"><br>
