...
<table class="table table-bordered">
    ...
    <tbody>
        <form action="<%=request.getContextPath() %>/semi/notice.do?cmd=insert" method="post">
            <tr>
                <th>제목: </th>
                <td><input type="text" placeholder="제목을 입력하세요. " name="notTitle" class="form-control"/></td>
            </tr>
            <tr>
                <th>내용: </th>
                <td><textarea cols="10" rows="10" placeholder="내용을 입력하세요. " name="notContent" class="form-control"></textarea></td>
            </tr>
            <tr>
                <td colspan="2">
