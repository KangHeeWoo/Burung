...
public class BoardCommentController extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		switch (cmd) {
		case "comminsert":
			boardcomminsert(request, response);
			break;
		case "commlist":
			boardcommlist(request, response);
			break;
		case "commdelete":
			boardcommdelete(request, response);
			break;
		}
	}

	protected void boardcommdelete(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	protected void boardcommlist(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		BoardCommentDao dao = BoardCommentDao.getinstance();
	...
	protected void boardcomminsert(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
